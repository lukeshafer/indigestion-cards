import { NO_CARDS_OPENED_ID, FULL_ART_ID, LEGACY_CARD_ID } from '@lib/constants';
import { routes } from '~/config';
import Card from '~/components/cards/Card';
import { For, Show, createSignal } from 'solid-js';
import { Select } from '~/components/Form';
import type { CardInstance, CardDesign } from '@core-types/db';
import { useViewTransition } from '~/lib/utils';
import type { RarityRankingRecord } from '@lib/site-config';
