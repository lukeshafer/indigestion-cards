import { ssr, ssrHydrationKey, ssrAttribute, escape, createComponent, Dynamic, mergeProps as mergeProps$1 } from "solid-js/web";
import { m as markdown, T as Title, A as ASSETS } from "./assets/index-ad02a4fd.js";
...
function defaultUnknownHandler(state, node2) {
  ...
  const result = "value" in node2 && !(own$3.call(data, "hProperties") || own$3.call(data, "hChildren")) ? {
    type: "text",
    value: node2.value
  } : {
    type: "element",
...
var MarkdownChildren = (props) => createComponent(For, {
  ...
  children: (child, index2) => createComponent(Switch, {
    get children() {
...
var MarkdownNode = (props) => {
  const childProps = createMemo(() => {
    ...
    properties.key = [name, position2.start.line, position2.start.column, props.index].join("-");
    if (name === "a" && options.linkTarget) {
      properties.target = typeof options.linkTarget === "function" ? options.linkTarget(String(properties.href || ""), node2.children, typeof properties.title === "string" ? properties.title : void 0) : options.linkTarget;
    }
    if (name === "a" && options.transformLinkUri) {
      properties.href = options.transformLinkUri(String(properties.href || ""), node2.children, typeof properties.title === "string" ? properties.title : void 0);
    }
...
var SolidMarkdown = (opts) => {
  ...
  return ssr(_tmpl$$1, ssrHydrationKey() + ssrAttribute("class", escape(options.class, true), false), escape(createComponent(MarkdownRoot, {
    context: {
      options,
      schema: html,
      listDepth: 0
...
const _tmpl$ = ["<div", ' class="flex flex-col gap-28 overflow-x-hidden"><section class="flex min-h-[30rem] flex-row-reverse flex-wrap items-center justify-center justify-items-center gap-4 gap-y-8"><div class="-mx-12 -mr-20 flex origin-top justify-center pb-24"><img style="', '"', ' width="200" class="w-52 origin-top-right translate-x-12 translate-y-6 -rotate-12 shadow-xl shadow-black/50 transition-transform duration-500 ease-in-out hover:translate-y-2"><img style="', '"', ' width="200" class="w-52 origin-top-left rotate-6 shadow-xl shadow-black/50 transition-transform duration-500 ease-in-out hover:-translate-y-4"><img style="', '"', ' width="200" class="w-52 origin-top-left -translate-x-12 translate-y-6 rotate-[18deg] shadow-xl shadow-black/50 transition-transform duration-500 ease-in-out hover:translate-y-2"></div><h2 class="font-heading w-max text-[2.5rem] font-semibold leading-none text-gray-600 dark:text-gray-300">Trading<sup class="">*</sup> cards<br>for the <s class="font-bold">cult</s><span class="text-brand-main text-shadow block font-bold">community</span><p class="py-8 text-xs">* Cards not yet tradeable.</p></h2></section><article class="prose prose-h2:uppercase prose-h2:text-center prose-h2:text-gray-600 dark:prose-h2:text-gray-300 prose-h2:font-bold prose-h2:text-3xl prose-h3:font-heading prose-h3:text-2xl prose-h3:font-semibold prose-h3:text-gray-700 dark:prose-h3:text-gray-200 dark:prose-strong:text-white dark:prose-strong:font-bold prose-a:text-blue-900 dark:prose-a:text-blue-100 mx-auto max-w-3xl text-left text-lg text-gray-900 dark:text-gray-100">', "</article></div>"];
function Home() {
  return [createComponent(Title, {
    children: "Indigestion Cards"
  }), ssr(_tmpl$, ssrHydrationKey(), "view-transition-name:ryan-of-the-wild-hero-card", ssrAttribute("src", escape(ASSETS.CARDS.HERO_CARD_1, true), false), "view-transition-name:lilindcult-hero-card", ssrAttribute("src", escape(ASSETS.CARDS.HERO_CARD_2, true), false), "view-transition-name:lilindheart-hero-card", ssrAttribute("src", escape(ASSETS.CARDS.HERO_CARD_3, true), false), escape(createComponent(FAQ, {})))];
}
export {
  Home as default
};
