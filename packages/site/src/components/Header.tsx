...
export default function Header(props: {
	...
	const canSeeTradesLink = () => (ctx?.session?.type === 'user' || ctx?.session?.type === 'admin') && siteConfig.data?.tradingIsEnabled
				...
				<nav
					...
					<a href="/" title="Home" class="mr-4 flex w-fit min-w-[2rem] items-center gap-4">
						...
						<div class="font-display hidden flex-1 flex-col pt-1 sm:flex">
							...
							<span class="-mt-2 text-lg lowercase text-gray-700 dark:text-gray-200">Cards</span>
						</div>
					</a>
