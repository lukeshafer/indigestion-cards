import { FaBrandsPatreon, FaBrandsTwitch, FaBrandsYoutube } from 'solid-icons/fa'
		...
		<footer class="grid justify-center gap-1 border-t border-t-gray-300 bg-white py-6 text-center text-sm dark:border-t-gray-800 dark:bg-gray-950">
			<nav class="flex items-center gap-8">
				<a
					...
					title="Twitch">
					<FaBrandsTwitch class="text-brand-main w-11" size={44} />
				...
				<a
					...
					class="hover:brightness-90"
					title="YouTube">
					<FaBrandsYoutube class="text-brand-main w-12" size={48} />
				...
				<a
					...
					class="hover:brightness-90"
					title="Patreon">
					<FaBrandsPatreon class="text-brand-main w-10" size={40} />
					<span class="sr-only">Patreon</span>
				</a>
			</nav>
			<p>&copy; {new Date().getFullYear()} lil_indigestion</p>
		</footer>
	);
}
