...
import { getSiteConfig as getSiteConfigServer } from '@lil-indigestion-cards/core/lib/site-config';
...
export const route = { load: () => getSiteConfig() };

export default function Home(props: RouteSectionProps) {
	const siteConfig = createAsync(() => getSiteConfig());
	return (
		<>
