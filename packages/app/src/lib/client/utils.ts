...
import { object, string, number, optional, type Output, type ObjectSchema } from 'valibot'
...
export const cardListItemSchema = object({
	rarityName: string(),
	cardName: string(),
	cardDescription: string(),
	designId: string(),
	...
	openedAt: optional(string()),
	frameUrl: string(),
	imgUrl: string(),
	rarityColor: string(),
}) 
export type CardListItem = Output<typeof cardListItemSchema>;
